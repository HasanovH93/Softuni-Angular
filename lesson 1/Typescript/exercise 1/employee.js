...
exports.Manager = exports.Seinior = exports.Junior = exports.Employee = void 0;
...
var Seinior = /** @class */ (function (_super) {
    __extends(Seinior, _super);
    function Seinior() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.tasks = [
...
exports.Seinior = Seinior;
var Manager = /** @class */ (function (_super) {
    __extends(Manager, _super);
    function Manager() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.tasks = [
            "".concat(_this.name, " scheduled a meeteing"),
            "".concat(_this.name, " is preparing quertly report"),
        ];
        return _this;
    }
    return Manager;
